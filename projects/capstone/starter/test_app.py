...
class CapstoneTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.casting_assistant_token = ('eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Ik9YcDlybEhPTlhJUDJkeXV6VWRaZCJ9..GIvpeB0w8b9UmiN80WmzovGq3h60z3Sy0XElOrQxL_po73y-d7Q7YQAEk3nStGL5QQ78-gOvwT9BuPun6UzGbNnt5f0WLEWlC_3Av10ZhTrObDGVKJRvWUJ7ea1f-g9W075hPiUGCXhiFtjcmMG3vTZDj3iyeTZgzG6z6gxMZbRVoLAX0iLv4YlW1KY1a_nXTc-dAwQCJLbei4U4HqbH630k6ep5SqAgqPUtr3grjtowkDiLhWATGdG4x-Xjd1GuGXGFdiJirlMvALRk2e31IzCuf0_Nu7yZt_TK_YD5MzSnfWE8hDAJ9qTnMgk5yqmgODVhPcmpBRNpQ7tYHowg7Q')
...
##---------------------------------------------------------------
    ...
    def test_post_actors_failure(self):
        res = self.client().delete('/actors', headers=self.casting_director_header, json=json.loads['release_date': '08-10-2000'])
    ...
    def test_post_movies_failure(self):
        res = self.client().delete('/movies', headers=self.executive_producer_header, json=json.loads['age': '31'])
